...
import { EventEmitter, Input, Output, Component, forwardRef, ViewEncapsulation, ElementRef, ChangeDetectorRef, ViewContainerRef, ComponentFactoryResolver, HostListener, Directive, NgModule, ɵɵdefineInjectable, ɵɵinject, Injectable } from '@angular/core';
...
var UTILITY = {
    ...
    isFunction: isFunction, hasKey: hasKey, sort: sort, noop: noop$1
};
